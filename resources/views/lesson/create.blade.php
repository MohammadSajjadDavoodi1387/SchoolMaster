        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white rounded-lg shadow p-6 max-w-xl mx-auto">
                <form action="{{ route('lessons.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 mb-2" for="base">نام پایه کتاب به عدد</label>
                        <input id="base" name="base" type="text" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    <div class="mb-4">
