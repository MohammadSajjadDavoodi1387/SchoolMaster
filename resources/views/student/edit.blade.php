...
@section('content')
    <main class="flex-1 p-8 bg-gray-50 min-h-screen">
        <header class="bg-gradient-to-r from-indigo-800 to-blue-600 shadow-lg rounded-xl p-6 mb-8 flex items-center justify-between animate-gradient">
            <h1 class="text-2xl font-bold text-white">ویرایش اطلاعات دانش آموز</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in max-w-4xl mx-auto">
            <form action="{{ route('student.update', $students->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="name" name="name" type="text" value="{{ $students->name }}" required
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="code" name="code" type="text" value="{{ $students->code }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="phone" name="phone" type="text" value="{{ $students->phone }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="email" name="email" type="email" value="{{ $students->email }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="nameFather" name="nameFather" type="text" value="{{ $students->nameFather }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="codeFather" name="codeFather" type="text" value="{{ $students->codeFather }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="phoneFather" name="phoneFather" type="text" value="{{ $students->phoneFather }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="nameMother" name="nameMother" type="text" value="{{ $students->nameMother }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="codeMother" name="codeMother" type="text" value="{{ $students->codeMother }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="phoneMother" name="phoneMother" type="text" value="{{ $students->phoneMother }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="avatar" name="avatar" type="text" value="{{ $students->avatar }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input id="base" name="base" type="text" value="{{ $students->base }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <select id="isActive" name="isActive" required
                                ...
                                <option value="1" {{ $students->isActive == 1 ? 'selected' : '' }}>فعال</option>
                                <option value="0" {{ $students->isActive == 0 ? 'selected' : '' }}>غیرفعال</option>
                            </select>
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    ...
                    <div class="mb-6 md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="3"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-400"
                            placeholder="آدرس کامل">{{ $students->address }}</textarea>
                    </div>
                </div>
